...
namespace Restaurant_Management.Infra.Repository
{
    public class Helper : IHelper
    {
        ...
        public Helper(RestaurantContext DbContext)
        {
            this._DbContext = DbContext;
        }
        public Helper(RestaurantContext DbContext, IConfiguration configuration)
        {
            this._DbContext = DbContext;
        ...
        public bool ValidateJWTtoken(string tokenString)
        {
            ...
            try
            {
                ...
                Log.Information("Get Token Suceessfully");
            }
            catch (Exception ex)
            {
                Log.Error("ValidateJWTtoken return this error :" + ex.Message);
            }
            return false;
        }
